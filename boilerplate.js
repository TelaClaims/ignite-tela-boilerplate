 ...
 *
 * Docs: https://infinitered.github.io/gluegun/#/context-api.md
 */
async function install (context) {
  ...
  const templates = [
    ...
    { template: 'jest.config.js.ejs', target: 'jest.config.js' },
  ...
  /**
   * Install and link React Native packages
   */
  ...
  // install selected react native packages
  try {
